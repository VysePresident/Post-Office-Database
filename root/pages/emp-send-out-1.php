        ...
        ?>
            ...
            <div class="form-col">
                    <div>
                        ...
                        <span>
                            <h5>Send Package Out</h5>
                        </span>
                    </div>

                    <form method="post" action="emp-send-out-2.php" autocomplete="off">
                        <div>
                            <span>
                                <h2>Package ID</h2>
                            </span>
                    ...
                    <button type="submit" class="hero-btn red-btn" id="send-out-btn">Mark For Send Out</button>

                    <!----------------------------------------------------->
                    <br></br>
                    <div>
                        <h5>Recieved Packages</h5>
                    </div>
                    <p>The following packages have been marked as recieved by this post office and are ready to be sent out to it's next location.</p>
